<x-layouts.employee title="Post-Test - {{ $training->title }}">
    <div class="space-y-6">
        <x-page.header
            eyebrow="Post-Test"
            title="{{ $training->title }}"
            description="Kerjakan semua soal post-test berikut. Pastikan setiap soal terjawab sebelum submit."
        >
        ...
        <form method="POST" action="{{ route('employee.post-test.submit', $training) }}" class="space-y-6">
            @csrf
            ...
            <div class="flex justify-end gap-3">
                ...
                <x-button.primary type="submit">Submit Post-Test</x-button.primary>
            </div>
        </form>
    </div>
</x-layouts.employee>
